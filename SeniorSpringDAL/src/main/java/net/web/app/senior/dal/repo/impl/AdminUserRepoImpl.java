...
public class AdminUserRepoImpl extends AbstractEntityRepo<AdminUserEntity> implements AdminUserRepo {
    ...
    public AdminUserEntity checkLogin(String userName, String password, int active) {
        ...
        conditions[2] = criteriaBuilder.equal(root.get("active"), active);
        ...
        if (resultList.size() > 0) {
            adminUserEntity = resultList.get(0);
        }
