...
public class ProviderBean {
    ...
    public ProviderBean(String name, String nameAr, String nameEn, String defaultLogoPath, String logoPathEn, String hotline, String logoPathAr) {
        this.name = name;
        this.nameAr = nameAr;
        this.nameEn = nameEn;
        this.defaultLogoPath = defaultLogoPath;
    ...
    private Set<ProviderUsersBean> providerUsersBean = new HashSet<>(0);
    ...
    public Set<ProviderUsersBean> getProviderUsersBean() {
        return providerUsersBean;
    }

    public void setProviderUsersBean(Set<ProviderUsersBean> providerUsersBean) {
