...
public class ProductBean {
    ...
    public ProductBean(String name, String nameAr, String nameEn, float price, String description, String descriptionAr, String descriptionEn, String imagePath, byte active, CategoryBean categoryBean) {
        this.name = name;
        this.nameAr = nameAr;
        this.nameEn = nameEn;
        this.price = price;
