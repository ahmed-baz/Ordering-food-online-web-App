    ...
    <body>
        <div class="container">
            <div class="table-wrapper">
                    ...
                    <tbody>
                        ...
                        <c:forEach items="${cityList}" var="iCity"> 
                            <tr>
                                ...
                                <td>
                                    <a href="ViewCity.jsp?id=<c:out value="iCity.id"/>">
                                ...
                                <td>
                                    <a href="UpdateCity.jsp?id=<c:out value="${iCity.id}"/>">
                                        <i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i>
                                    </a>
                                    <a href="DeleteCurrentCity?delete_id=<c:out value="${iCity.id}"/>" class="delete" data-toggle="modal"
                ...
                <div class="clearfix">
                    <div class="hint-text">Showing <b>5</b> out of <b><c:out value="${cityList.size()}"/></b> entries</div>
                    <ul class="pagination">
